...
(function() {
    ...
    _.typeOf = function(anything) {
        ...
        else if (anything.length > 0 && typeof anything !== "string") {
            return "array";
        }
    ...
    //return the first 'n' element in an array
...
//4
 ...
 _.last = function(array, number) {
        ...
        //to count backwards in an array use the below to use end - i
        let end = array.length - 1;      
        var out = [];
        for (var i = 0; i < number; i++) {
            out.unshift(array[end - i]);
        }
        return out;
    ...
    */
    ...
    _.reduce = function(list, iterator, seed) {
